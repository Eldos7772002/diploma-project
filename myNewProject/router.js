...
export const useRoute = (isAuth) => {
  ...
  return (
    <MainTab.Navigator
      ...
      />
      <MainTab.Screen
        name='Messages' // Название нового экрана
        component={MessagesScreen} // Компонент для нового экрана
        options={{
          tabBarIcon: ({ focused, size, color }) => (
            <Feather name="message-circle" size={size} color='#212121CC' style={{ marginTop: 10 }} />
          ),
          headerShown: false,
        }}
      />
